...
<div style="max-width: 600px; margin: 0 auto;">
    <div style="margin-bottom: 2rem;">
        <h1 style="font-size: 2.5rem; font-weight: 800; color: var(--primary);">My Profile</h1>
    ...
    <div class="glass-card">
        <form action="{{ route('student.profile') }}" method="POST">
            ...
            <p style="font-weight: 600; margin-bottom: 1rem;">Change Password <span style="font-weight: 400; font-size: 0.8rem; color: var(--text-muted);">(Leave blank to keep current)</span></p>
